...
function renderChrome() {
  ...
  header.innerHTML = '<div class="header-left"><a href="/"><svg width="24" height="24" viewBox="0 0 24 24" style="display:block"><defs><linearGradient id="lg" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#00d4aa"/><stop offset="100%" stop-color="#00a8e8"/></linearGradient></defs><path d="M4,20 Q3,14 6,11 Q9,8 7,3" fill="none" stroke="url(#lg)" stroke-width="2.2" stroke-linecap="round"/><polyline points="17,18 10,12 13,8 7,3" fill="none" stroke="url(#lg)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg><span style="font-size:1.05rem;font-weight:700;background:linear-gradient(90deg,#00d4aa,#00a8e8);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">Stock <span style="color:#8899aa;background:none;-webkit-text-fill-color:#8899aa">in</span></span><span style="font-size:0.65rem;color:var(--color-text-muted);margin-left:6px;border:1px solid var(--color-border);border-radius:3px;padding:1px 5px;">V1.0.0 test</span></a></div><button class="hamburger-btn" id="hamburgerBtn" aria-label="菜单" onclick="toggleMobileNav()">☰</button><nav id="topNav" class="header-nav"></nav><div class="mobile-nav-overlay" id="mobileOverlay" onclick="closeMobileNav()"></div>';
